...
class TunaListFragment : androidx.fragment.app.Fragment() {
    ...
    internal inner class TunaListAdapter(context: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<ViewHolder>() {
